    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.validity.valueMissing) {
                message = errorMessages.valueMissing;
                ...
                message = input.title || errorMessages.patternMismatch;
            }
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(function(input) {
                if (!input.disabled && !input.readOnly && input.required !== undefined) {
        ...
        contactForm.addEventListener('blur', function(e) {
            ...
            if (input && input.form === contactForm) {
                validateField(input);
            }
        }, true);
        ...
        contactForm.addEventListener('input', function(e) {
            const input = e.target.closest('input, textarea, select');
            if (input && input.form === contactForm && input.classList.contains('error')) {
                validateField(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a267a51c-6e63-4d14-a354-4fe58161409e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a267a51c-6e63-4d14-a354-4fe58161409e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a267a51c-6e63-4d14-a354-4fe58161409e';
